...
/**
 * A fragment class for the help section of the world wonders part of the app
 */
public class HelpWorldWonderFragment extends DialogFragment {


    public HelpWorldWonderFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_help_world_wonder, container, false);
    }
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState)
    {
        ...
        builder.setMessage(R.string.helpWorldWonderText)
