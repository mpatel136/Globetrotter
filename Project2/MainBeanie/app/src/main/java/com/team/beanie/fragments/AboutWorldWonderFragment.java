...
/**
 * A fragment class for the about section of the world wonder part of the app
 */
public class AboutWorldWonderFragment extends DialogFragment {


    public AboutWorldWonderFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_about_world_wonder, container, false);
    }
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState)
    {
        ...
        builder.setMessage(R.string.aboutWorldWonderText)
